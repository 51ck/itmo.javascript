;(function(app){
    ...
    let arrayMin = function ( array, index = false ) {
        if ( array instanceof Array ) {
            let min = 0;
            ...
            return index ? min : array[min];
        } else {
            return null;
        };
    };

    let arrayMax = function ( array, index = false) {
        if ( array instanceof Array ) {
            let max = 0;
            for ( let i = 1, n = array.length; i < n; i++ ) {
    ...
    let arrayAverage = function ( array ) {
        if ( array instanceof Array ) {
            let temp = weedOut( array, function( e ) {
